...
CREATE TABLE IF NOT EXISTS `RENDI`.`produtos` (
  ...
  PRIMARY KEY (`id`, `id_setor`, `id_ordem_compra`, `id_unidade_medida`),
  INDEX `fk_produtos_setores1_idx` (`id_setor` ASC),
  INDEX `fk_produtos_ordens_compra1_idx` (`id_ordem_compra` ASC),
  ...
  CONSTRAINT `fk_produtos_setores1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_produtos_ordens_compra1`
